...
class ChatActivityDoctor : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ConsultAppTheme {
                // Get the patient name from intent
                val patientName = intent.getStringExtra("chatPartner") ?: "Unknown Patient"
                val currentUser = FirebaseAuth.getInstance().currentUser
                val doctorName = currentUser?.displayName ?: "Unknown Doctor"
                ...
                ChatBaseView(
                    ...
                    onSendMessage = { message, imageUri, fileUri ->
                        val senderName = doctorName
                        val receiverName = patientName
    ...
    private fun getChatRoomId(user1: String, user2: String): String {
        return "${user1}-${user2}"  // This will create a dynamic chat room ID like "Doctor-Patient"
    }
